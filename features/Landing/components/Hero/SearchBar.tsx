        ...
        <div className="bg-white border border-gray-400 rounded-md px-6 py-3 max-w-2xl shadow-sm" role="search">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <div className="relative flex-1 min-w-[130px]">
              <label htmlFor="location-select" className="sr-only">{t("locationLabel")}</label>
              <select
                id="location-select"
            ...
            <div className="flex items-center gap-2 flex-1 min-w-[120px] border border-gray-300 rounded-lg px-3 py-2 focus-within:ring-2 focus-within:ring-indigo-500">
              <label htmlFor="budget-input" className="sr-only">{t("budgetLabel")}</label>
            ...
            <div
              ...
              dir="rtl"
            >
              <label htmlFor="check-in-date" className="sr-only">{t("checkInLabel")}</label>
              <input
                id="check-in-date"
                type="date"
