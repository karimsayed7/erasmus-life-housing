    ...
    <div>
      <FieldGroup>
        ...
        <div className="flex gap-5">
            ...
            <div className="flex-1">
                <InputField type="number" form={form} label="lat" name="lat" transilation="add edit room"/>
            </div>
            <div className="flex-1">
                <InputField type="number" form={form} label="lng" name="lng" transilation="add edit room"/>
            </div>
        </div>
        <TextareaField isEditing={true} form={form} label="description" name="description" transilation="add edit room"/>
        <div className="flex gap-5">
            <InputField type="number" form={form} label="bedrooms" name="attrs.bedrooms" transilation="add edit room"/>
            <InputField type="number" form={form} label="size" name="attrs.size" transilation="add edit room"/>
            <InputField type="number" form={form} label="bathrooms" name="attrs.bathrooms" transilation="add edit room"/>
        </div>
      </FieldGroup>
    </div>
  )
